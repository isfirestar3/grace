...
QT_MOC_LITERAL(1, 9, 17), // "sigUpdateMousePos"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 3) // "pos"

    },
    "MapScene\0sigUpdateMousePos\0\0pos"
};
...
void MapScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigUpdateMousePos((*reinterpret_cast< const QPointF(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MapScene::*_t)(const QPointF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MapScene::sigUpdateMousePos)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject MapScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_MapScene.data,
      qt_meta_data_MapScene,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void MapScene::sigUpdateMousePos(const QPointF & _t1)
{

...
typedef enum {
    ...
    canERR_DEVICE_FILE     = -33,    // Device File error
    canERR_HOST_FILE       = -34,    // Host File error
    canERR_DISK            = -35,    // Disk error
    canERR_CRC             = -36,    // CRC error
    canERR_CONFIG          = -37,    // Config error
    canERR_MEMO_FAIL       = -38,    // Memo failure
    canERR_SCRIPT_FAIL     = -39,    // Script error

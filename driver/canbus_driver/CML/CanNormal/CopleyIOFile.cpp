...
#define MAX_LINE_SEGS 4
   ...
   while( !feof(fp) && !err )
   {
	 ...
	 continue;
      ...
      {
		err = StrToInt16( seg[1], bank, 10 );	//Add error check here
	...
	// This increment is required to convert between the file 0-9 bank enumerations and
	// CML 1-10 bank enumerations.
	bank++;

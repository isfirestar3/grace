...
/***************************************************************************/
/**
This is an event that matches if any of a group of bits are changed in the
EventMap mask.
*/
/***************************************************************************/
...
public:
	 ...
	 */
	/***************************************************************************/
	EventChange( uint32 v=0 ):Event(v) {}
	 ...
	 */
	EventChange( const EventChange &e ):Event(e){}

	/***************************************************************************/
	/**
		Check the event.  The event is satisfied if any of the selected bits are changed
	    in the mask.
	...
	{
//		uint32 old = getMask() & value;
		return (mask & value) != (getMask() & value);
	}
};

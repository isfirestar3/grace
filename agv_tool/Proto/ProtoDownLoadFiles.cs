...
{
    public class ProtoDownLoadFiles : ProtoInterface_t
    {
        Tool.Proto.ProtoList_t<DownLoadFiles> fileList = new Proto.ProtoList_t<DownLoadFiles>();
        public List<DownLoadFiles> FileListList
        {
            get
            {
                return fileList;
    ...
    public class DownLoadFiles : ProtoInterface_t
    {
